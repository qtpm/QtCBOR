...
output_static::~output_static() { delete _buffer; }
...
unsigned char* output_static::data() { return _buffer; }

unsigned int output_static::size() { return _offset; }

void output_static::clear() { this->_offset = 0; }
