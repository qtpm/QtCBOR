...
private Q_SLOTS:
	...
	{
		QMap<QString, QVariant> map{{"integer", 10}, {"bool", true}, {"double", 10.5},
			{"map", QMap<QString, QVariant>{{"string", "string"}}}};
	...
	{
		QMap<QString, QVariant> map{
			{"path", "/test"}, {"method", "method"}, {"params", QVariantList{"abc.png", 0777}}};
